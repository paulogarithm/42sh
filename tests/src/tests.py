...
def create_bar(percentage: int, name: str) -> str:
    ...
    col = my_color.red
    col = my_color.orange if percentage >= 33 else col
    col = my_color.green if percentage >= 66 else col
    # col = my_color.blue if percentage == 100 else col
